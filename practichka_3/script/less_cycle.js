...
//2
let n2 = parseInt(prompt("Завдання 2: Введіть число N:"));
...
//3
let n3 = parseInt(prompt("Завдання 3: Введіть число N:"));
let sum3 = 0;
for (let i = 1; i <= n3; i++) {
    sum3 += i;
}
...
//4
let n4 = parseInt(prompt("Завдання 4: Введіть число N:"));
...
//6
let password6;
const correctPassword6 = "123123";
do {
    password6 = prompt("Завдання 6: Введіть пароль: (123123)");
